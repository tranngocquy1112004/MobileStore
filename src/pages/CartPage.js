...
const CartSummary = ({ totalPrice, onCheckout }) => (
  <div className="cart-summary">
    <h3 className="total-price">Tổng tiền: {totalPrice.toLocaleString("vi-VN")} VNĐ</h3>
    <button className="checkout-button" onClick={onCheckout}>🛍 Mua hàng</button>
  </div>
);

const EmptyCart = () => <p className="empty-cart-message">{MESSAGES.EMPTY_CART}</p>;
    ...
    <div className="cart-container">
      ...
      {cart.length === 0 ? (
        ...
        <>
          ...
          <button className="clear-cart-button" onClick={handleClearCart}>Xóa tất cả</button>
      ...
      <div className="cart-links">
        <Link to="/orders" className="order-history-link">📜 Xem lịch sử đơn hàng</Link>
